...
<head>
    <meta charset="utf-8">
    <title>Fasilitas | WebGIS Battang Barat</title>
    ...
    <section class="hero-inner pt-32 pb-20 text-white">
        ...
        <div class="container mx-auto px-6 relative z-10">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm">
                    ...
                    <li>
                        <div class="flex items-center text-slate-400">
                            ...
                            <span class="text-blue-400 font-bold">Fasilitas Umum</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <p class="text-slate-300 max-w-2xl text-lg animate__animated animate__fadeInUp animate__delay-1s">
                Sebaran titik lokasi sekolah, rumah ibadah, kesehatan, dan fasilitas publik lainnya di Battang Barat.
            </p>
        </div>
    </section>
...
@foreach($fasilitass as $fasilitas)
    ...
    var jenis = "{{ $fasilitas->kategori }}";
    var icon = icons[jenis] || icons["Sekolah"];
