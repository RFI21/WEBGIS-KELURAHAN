...
<head>
  ...
  <title>Tambah Potensi | WEBGIS TERPADU KELURAHAN BATTANG BARAT</title>
...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <div class="card mb-4">
        <div class="card-header bg-dark text-white">Form Tambah Potensi</div>
        <div class="card-body">
          <form method="POST" action="{{ route('admin.potensi.simpan') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
              ...
              <input type="text" name="nama" id="nama" class="form-control" rows="3" required></input>
            </div>
